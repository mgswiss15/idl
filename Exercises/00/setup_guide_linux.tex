...
\end{lstlisting}
\begin{tipbox}
This step is optional but helps keep your virtual environments organized.
\end{tipbox}

Need to install python3-venv module
...
Create a base virtual environment for testing
\begin{lstlisting}[language=bash]
python3 -m venv ~/venvs/idl
\end{lstlisting}

Activate the test environment
\begin{lstlisting}[language=bash]
source ~/venvs/idl/bin/activate
\end{lstlisting}

# install pytorch from webpage
