...
\begin{figure}[h]
 \centering
 \tikzsetnextfilename{supervised_learning}
...
\begin{figure}[h]
 ...
 \centering
 \tikzsetnextfilename{classification_2d}
 ...
 \centering
 \tikzsetnextfilename{regression_1d}
...
\begin{wrapfigure}{r}{0.3\textwidth}
 \centering
 \tikzsetnextfilename{linear_neuron}
...
\begin{figure}[h]
 ...
 \centering
 \tikzsetnextfilename{regression_1d_line}
 ...
 \centering
 \tikzsetnextfilename{regression_1d_nonlinear}
...
\begin{wrapfigure}{r}{0.3\textwidth}
 \centering
 \tikzsetnextfilename{relu_neuron}
...
\begin{wrapfigure}{r}{0.3\textwidth}
 \centering
 \tikzsetnextfilename{regression_1d_relu_simple}
...
\begin{figure}[h]
 ...
 \begin{minipage}{0.48\textwidth}
 \centering
 \tikzsetnextfilename{relu_combi_simple_plot}
 \resizebox{\textwidth}{!}{\input{\CommonPath/tikz/relu_combi_simple_plot.tex}}
 \end{minipage}
 \hfill
 \begin{minipage}{0.48\textwidth}
 \centering
 \tikzsetnextfilename{relu_combi_double_plot}
...
\begin{figure}[h]
 ...
 \begin{minipage}{0.45\textwidth}
 \centering
 \tikzsetnextfilename{mlp_single_input}
 \resizebox{\textwidth}{!}{\input{\CommonPath/tikz/mlp_single_input.tex}}
 \end{minipage}
 \hfill
 \begin{minipage}{0.52\textwidth}
 \centering
 \tikzsetnextfilename{mlp_multi_input}
...
\begin{wrapfigure}{r}{0.3\textwidth}
    \centering
    \tikzsetnextfilename{regression_1d_piecewise}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \tikzsetnextfilename{classification_2d_math}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \tikzsetnextfilename{classification_2d_nonlinear}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \tikzsetnextfilename{artificial_neuron}
