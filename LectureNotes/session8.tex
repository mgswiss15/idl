...
\centering
\resizebox{0.36\textwidth}{!}{\input{\CommonPath/tikz/step_vs_smooth.tex}}
...
\centering
\resizebox{0.33\textwidth}{!}{\input{\CommonPath/tikz/sigmoid.tex}}
...
\begin{wrapfigure}{r}{0.38\textwidth}
\centering
\resizebox{0.36\textwidth}{!}{\input{\CommonPath/tikz/bce_loss.tex}}
...
\centering
\resizebox{0.40\textwidth}{!}{\input{\CommonPath/tikz/likelihood_illustration.tex}}
...
\begin{wrapfigure}{r}{0.42\textwidth}
\centering
\resizebox{0.40\textwidth}{!}{\input{\CommonPath/tikz/gaussian_regression.tex}}
...
\begin{wrapfigure}{r}{0.38\textwidth}
\centering
\resizebox{0.36\textwidth}{!}{\input{\CommonPath/tikz/entropy_distributions.tex}}
...
\begin{wrapfigure}{r}{0.38\textwidth}
\centering
\resizebox{0.36\textwidth}{!}{\input{\CommonPath/tikz/binary_entropy.tex}}
...
\begin{wrapfigure}{r}{0.42\textwidth}
\centering
\resizebox{0.40\textwidth}{!}{\input{\CommonPath/tikz/reliability_diagram.tex}}
...
Label smoothing is now standard in modern architectures: Inception v3 \parencite{Szegedy2016}, Vision Transformers, and modern ResNets all use it, consistently improving both accuracy and calibration with minimal cost. In PyTorch: \texttt{nn.CrossEntropyLoss(label\_smoothing=0.1)}.

A secondary benefit: label smoothing reduces the impact of individual noisy labels --- a wrong label in the training set causes less damage when the targets are soft rather than hard one-hot vectors.
...
\end{equation}
where $w_k$ is inversely proportional to the frequency of class $k$. In PyTorch: \texttt{nn.CrossEntropyLoss(weight=class\_weights)}.
