...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \tikzsetnextfilename{ai_ml_dl}
    \resizebox{0.35\textwidth}{!}{\input{\CommonPath/tikz/ai_ml_dl.tex}}
...
\begin{figure}[h]
    \centering
    \tikzsetnextfilename{ai_history.tex}
...
\begin{figure}[h]
    \centering
    \tikzsetnextfilename{dataset_scale.tex}
...
\begin{figure}[h]
    \centering
    \tikzsetnextfilename{gpu_performance.tex}
...
\begin{figure}[h]
    \centering
    \tikzsetnextfilename{imagenet_accuracy}
