...
\node[annot, carnelian] at (-0.2, 0.3) {c};
\draw[dotted, thick, carnelian] (1.5,1.3) -- (1.,1.3) -- (1.,0.9) node[annot, anchor=south east] {m};}

% Normal vector w
\onslide<2->{
\draw[thick, thwsorange] (0.0, 0.3) -- (3.6, 2.6) node[annot, anchor=south] {$\vw\T\vx + b = 0$};
\draw[-Stealth, thick, carnelian] (1.9, 1.5) -- ++(-0.3, +0.5) 
    node[right, annot, carnelian] {$\vw$};}
